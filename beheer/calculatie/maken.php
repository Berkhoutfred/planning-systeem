            ...
            <div class="box-body">
                ...
                <div class="route-compact" style="background: #fdfdfd; padding: 8px 10px; border: 1px solid #eee; border-radius: 4px;">
                    ...
                    <div class="rit-row" id="row_garage">
                        ...
                        <div class="col-adres"><label>Garage</label><input type="text" name="addr[t_garage]" id="addr_t_garage" class="form-control google-autocomplete" value="Industrieweg 95, Zutphen" placeholder="Garage..."></div>
                    </div>
                    ...
                    <div class="rit-row" id="row_voorstaan">
                        ...
                        <div class="col-adres"><label>Naar grens</label><input type="text" name="addr[t_voorstaan]" id="addr_t_voorstaan" class="form-control google-autocomplete" placeholder="Eerste grens / grensovergang..."></div>
                    ...
                    <div class="rit-row" id="row_retour_garage_heen" style="display:none; background:#f9f9f9; padding:5px; border-radius:4px;">
                        ...
                        <div class="col-adres"><label>Garage (na rit 1)</label><input type="text" name="addr[t_retour_garage_heen]" id="addr_t_retour_garage_heen" class="form-control google-autocomplete" value="Industrieweg 95, Zutphen" placeholder="Garage..."></div>
