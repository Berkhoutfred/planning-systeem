<?php
// beheer/voertuig-toevoegen.php
// VERSIE: Compleet Voertuigdossier (Inclusief Chassis, Type en Nummer)
...
<div style="max-width: 800px; margin: auto; padding-bottom: 50px;">
    ...
    <form method="POST" style="background: #f9f9f9; padding: 30px; border: 1px solid #ddd; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
        ...
        <h3 style="border-bottom: 2px solid #003366; padding-bottom: 5px; color: #003366;">1. Identificatie & Capaciteit</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 25px;">
            <div>
                <label>Voertuignummer (bijv. 12):</label>
                <input type="text" name="voertuig_nummer" style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
            <div>
                <label>Merk / Naam (bijv. Mercedes): *</label>
                <input type="text" name="naam" required style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
            <div>
                <label>Type (bijv. Tourismo):</label>
                <input type="text" name="type" style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
            <div>
                <label>Kenteken: *</label>
                <input type="text" name="kenteken" required style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
            <div style="grid-column: span 2;">
                <label>Chassisnummer (VIN):</label>
                <input type="text" name="chassisnummer" style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
            <div>
                <label>Aantal Zitplaatsen: *</label>
                <input type="number" name="zitplaatsen" required style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
            <div>
                <label>Euroklasse (bijv. Euro 6):</label>
                <input type="text" name="euroklasse" style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
            <div style="grid-column: span 2;">
                <label>Huidige Status:</label>
                <select name="status" style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
                    <option value="beschikbaar">🟢 Beschikbaar (Actief)</option>
                    <option value="werkplaats">🔴 In de Werkplaats / Defect</option>
                </select>
            </div>
        </div>

        <h3 style="border-bottom: 2px solid #003366; padding-bottom: 5px; color: #003366;">2. Keuringen & Veiligheid</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; margin-bottom: 25px;">
            <div>
                <label>APK Geldig Tot:</label>
                <input type="date" name="apk_datum" style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
            <div>
                <label>Tacho Geijkt Tot:</label>
                <input type="date" name="tacho_datum" style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
            <div>
                <label>Brandblusser Tot:</label>
                <input type="date" name="brandblusser_datum" style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px;">
            </div>
        </div>

        <h3 style="border-bottom: 2px solid #003366; padding-bottom: 5px; color: #003366;">3. Financieel & Onderhoudslogboek</h3>
        <div style="margin-bottom: 15px;">
            ...
            <input type="number" step="0.01" name="km_kostprijs" placeholder="bijv. 1.25" style="width: 100%; max-width: 200px; padding: 8px; border:1px solid #ccc; border-radius:4px; display: block; margin-top: 5px;">
        </div>
        <div style="margin-bottom: 15px;">
            ...
            <textarea name="onderhoud_notities" rows="4" style="width: 100%; padding: 8px; border:1px solid #ccc; border-radius:4px; margin-top: 5px;"></textarea>
        </div>
